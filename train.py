...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("LRAR", add_help=True)

    parser.add_argument("--data_root", type=str, default="./path/to/dataset/mvtec", help="train dataset path")
    parser.add_argument("--data_mode", type=str, default='mvtec_visa', choices=['mvtec_visa', 'mvtec_busi', 'mvtec_brats'], help="train dataset mode")
    ...
    parser.add_argument("--use_nrs", type=int, default=1, choices=[0, 1], help="enable Normal Relative Suppression (1=on, 0=off)")

    # Loss weights
    parser.add_argument("--contra_weight", type=float, default=5.0, help="weight for Proxy Contrastive Loss")
    parser.add_argument("--supp_weight", type=float, default=0.5, help="weight for Normal Relative Suppression loss")
